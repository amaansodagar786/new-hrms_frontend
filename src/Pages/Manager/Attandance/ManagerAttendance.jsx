...
const ManagerAttendance = () => {
    ...
    // Fetch today's attendance for manager
                ...
                {policy && (
                    <div className="policy-info">
                        ...
                        <div className="policy-details">
                            <span>Working Hours: {policy.attendanceRules?.workingHoursStart || '09:00'} - {policy.attendanceRules?.workingHoursEnd || '18:00'}</span>
                            <span>Grace Period: {policy.attendanceRules?.gracePeriodMinutes || 15} min</span>
                            <span>Half Day After: {policy.attendanceRules?.halfDayAfterMinutes || 180} min late</span>
                        </div>
                    </div>
                )}
            </div>
